          ...
          <div className="flex flex-col items-start justify-start w-full p-10 space-y-6">
            <Tabs className="w-full" defaultValue="login">
              ...
              <TabsContent value="login" className="space-y-4 mt-4">
                ...
                {/* Updated Login Button with new style */}
                <button
                  className="w-full mt-2 p-2 bg-black text-orange-500 text-lg  border-2 border-gray-500 rounded-2xl font-semibold hover:bg-amber-300 hover:text-black hover:border-yellow-500 transition-all duration-300"
                  onClick={handleLogin}
                >
                  Login
                </button>
