...
function Complain() {
  ...
  return (
    <>
      <Header /> 
      <div className="h-[100vh] w-full flex flex-col items-center justify-center bg-gradient-to-r from-gray-900 to-teal-800">
        <div className="bg-white max-w-lg w-full rounded-2xl shadow-2xl p-8 space-y-6 border-2 border-white">
          ...
          {/* MY COMPLAIN Button */}
          <button
            className="w-full mt-4 py-3 bg-orange-500 text-white font-semibold rounded-2xl hover:bg-orange-700 transition duration-300"
            onClick={() => navigate('/my-complain')} // Navigate to MY COMPLAIN page
          >
            MY COMPLAIN
          </button>
        </div>
